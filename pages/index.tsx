  ...
  <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
    <div className="bg-white p-6 rounded-3xl shadow-2xl">
      ...
      <div className="flex justify-between">
        <span className="text-gray-500">Gray Table</span>
      ...
      <button className="block mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-1/2 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:text-red-500">Checkout</button>
    </div>
